  ...
  return (
    <div className="min-h-full basis-1/4 bg-base-200   flex flex-col     ">
      ...
      <p className=" mx-10 mt-8 text-justify">
        ...
        page . I&lsquo;ve added REST api to app and deploy with Vercel you can
        toggle between dark and light theme in navbar which use the Context api
        . this web site use DaisyUi and Tailwind for styling and better
        appearance its completely responsive , last but not least ,this website
        has server side pagination and home page only shows 3 post per page but
        you can see other pages with nice designed pagination in bottom of page
      </p>
    </div>
  );
}
